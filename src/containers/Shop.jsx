...
import { get_products, get_filtered_products, get_search_products } from '../redux/actions/product'
...
const Shop = ({
    ...
    const showProducts = () =>{
      ...
      if( filtered_products && filtered_products !== null && filtered_products !== undefined && filtered_products){
